...
//    private static ParkingLots instance;
...
//
//    private ParkingLots(Map<Integer, ParkingFloor> parkingFloorMap,
...
//     */
//    public static ParkingLots getInstance(Map<Integer, ParkingFloor> parkingFloorMap,
//                                          ParkingStrategy parkingStrategy,
//                                          PricingStrategy pricingStrategy) {
//        instanceLock.lock();
//        try {
//            if (instance == null) {
//                instance = new ParkingLots(parkingFloorMap, parkingStrategy, pricingStrategy);
//            }
//            return instance;
//        } finally {
//            instanceLock.unlock();
...
//
//        ParkingLots lot = ParkingLots.getInstance(floorMap, strategy, pricing);
//
//        // Vehicles
